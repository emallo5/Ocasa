...
public class EditReceiptFragment extends BaseReceiptFragment implements EditReceiptView,
        AddItemsFragment.OnItemAddedListener, PickupItemConfirmationDialog.OnConfirmationListener,
        ReceiptItemsFragment.OnAddItemsListener {
    ...
    @Override
    public void onNotFoundItem(String code) {
        search.setText("");
        search.requestFocus();
        errorSound.start();
    ...
    public void onItemAdded(long recordId) {
        ...
        ((EditReceiptPresenter)getPresenter()).findItem(getArguments().getLong(ARG_RECEIPT_ID), recordId);
    }
